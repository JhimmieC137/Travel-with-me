                ...
                <div className="footerCard flex">
                    <div className="footerIntro flex">
                        ...
                        <div data-aos="fade-up" className="footerParagrapgh">
                            orem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Duis aute irure dolor in reprehenderit
                    ...
                    <div className="footerLinks grid">
                        ...
                        <div data-aos="fade-up" data-aos-duration="3000" className="linkGroup">
                            ...
                            <li className="footerList flex"><FiChevronRight className='icon'/>Toursm</li>
                        ...
                        <div data-aos="fade-up" data-aos-duration="5000" className="linkGroup">
                            ...
                            <li className="footerList flex"><FiChevronRight className='icon'/>Indonasia</li>
